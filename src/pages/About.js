  ...
  return (
    <div className='container'>
      ...
      <section className='aboutUs'>
        ...
        &nbsp;
        <div className='description-one'>Serendipity was founded by Sonia Zoref as a result of years of struggling dealing with her own mental health journey and finally finding the cathartic and therapeutic outcomes of working through various mediums of the Arts, in particular, Creative Writing and Mindfulness.
        ...
        Our workshops are informal and fun. There is no experience of writing necessary and in fact, you don’t even have to write, you can doodle, watch, listen or talk. The emphasis being on building better stronger communities/friendships and participating in something special.
        The Facilitator provides generic writing exercises that usual last ten minutes, then we offer the opportunity for members to read their work if they so wish to. Quite often this results in small discussions. Its good to talk, good to share, and the only rule we have is that there are no rules.
        As long as we all respect each other, all positive feedback is welcomed.</div>
        &nbsp;
        <div className='description-two'>We have been a founded organisation since 2018, reaching <span className='word-highlights'> charitable status</span> in December 2022.</div>
        &nbsp;

        <div className='description-three'> Mental Health, like physical health is on a spectrum, and we work to reduce the stigma often attached. Everyone one of us, at some time or other suffer with our mental health; from severe mental health illness’ to poverty or loneliness. Serendipity is all about feel good. Everyone (16 years +) from all backgrounds and all experiences are welcome to join us. We also welcome immigrants and refugees). In fact, we embrace our differences and share our stories with one another in an informal yet educational environment that helps reduce misunderstanding, racism and hate crime.
        ...
        Serendipity work with school term times, but we hold Natter Groups during the school holiday (these are free sessions but a pay-for-your-own refreshments meeting)</div>
        &nbsp;
        <div className='description-four'> All our workshops are in local Community Café’s because we know that it is important for people to feel <span className='word-highlights'>safe and welcome</span> in normalised settings.</div>
        </p>
      </section>
